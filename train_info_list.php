            ...
            <tbody class="divide-y divide-gray-200 bg-white">
                <?php
                    foreach ($data as $key => $value) {
                        ?>
                       <tr>
                <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6"><?php echo $value['id']?></td>
                <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6"><?php echo $value['train_name']?></td>
                ...
                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500"><?php echo $value['train_type']?></td>
